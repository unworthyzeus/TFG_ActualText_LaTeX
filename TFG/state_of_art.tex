...
Use the Try~78 LoS prior plus a calibrated NLoS morphology model. \\
...
Use Try~79 log-domain ridge priors with topology, height, and LoS/NLoS regimes. \\
...
Use a Try~80 prior-anchored residual GMM. \\
...
Try~80 combines the pieces that survived those comparisons: calibrated priors,
...
Try~80 is also not presented as a universal radio-map foundation model. It is a
...
\textbf{Try~80 (this thesis)} & \textbf{1.65\,dB on unseen test cities} & \textbf{Yes} & \textbf{Final prior-anchored residual model; also improves delay-spread and angular-spread RMSE over the frozen priors.} \\
\bottomrule
\end{tabularx}
\end{table}
\normalsize
The Try~80 number in Table~\ref{tab:position} is the final frozen-checkpoint

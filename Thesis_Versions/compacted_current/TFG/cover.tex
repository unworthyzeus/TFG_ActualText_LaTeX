\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south,at=(current page.south west),xshift=0.75cm,yshift=0.5cm] {\rotatebox{90}{\textcolor{white}{\Huge\bfseries \raisebox{0pt}{ETSETB} \textbar{} \LARGE\DegreeName}}};
  \end{tikzpicture}

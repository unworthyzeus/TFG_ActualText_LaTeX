...
architecture. The propagation ingredients follow classical FSPL, two ray,
...
follow in the same methodology chapter, so the design and the audit trail
remain together.
...
single-output point regression was a poor match for blocked, multimodal,

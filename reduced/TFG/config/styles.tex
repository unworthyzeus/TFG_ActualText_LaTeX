...
% Keep remaining page space at the bottom instead of stretching gaps between
% tables, figures and section headings.
\raggedbottom
...
% Keep equations and floats from opening large vertical gaps. The template
% defaults are generous; these values are still readable but avoid half-empty
% pages in equation-heavy methodology sections.
...
\DeclareCaptionFont{degreecolor}{\color{DegreeColor}}
\captionsetup{
  labelfont={degreecolor,sf,bf},
  textfont={it,small},
...
\hypersetup{
  ...
  linkcolor=DegreeColor,
  citecolor=DegreeColor,
  urlcolor=UPCblue,

...
mixed precision with batch size 1 took \SI{5.61}{s} per map end to end. The
component means were \SI{4.71}{s} for LoS/NLoS mask generation,
\SI{0.35}{s} for the frozen priors, and \SI{0.54}{s} for the Try~80 neural
forward pass. The mask-generation stage is therefore the bottleneck, not the
network itself.
...
The resulting measured speed-up is \(17.8\times\) for the complete non-RT

...
(Eq.~\eqref{eq:field_sum}) without the $d^4$ approximation. This is still a
...
Try 78/80 NLoS branch keeps that explanatory spirit, but fits the coefficients
...
Since $n_{\mathrm{raw}}(x') \in \{0,1\}$ (Eq.~\eqref{eq:nlos_mask_v2}),

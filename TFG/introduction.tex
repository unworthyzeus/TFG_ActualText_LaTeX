...
a ray tracer, which is satisfied automatically by any CNN-based surrogate once
...
\begin{itemize}
  ...
  \item A prior-anchored joint neural residual GMM-head model that shares
        ...
        the frozen path-loss and spread priors.
...
by a map head that assigns pixels to distribution components. The same idea was applied

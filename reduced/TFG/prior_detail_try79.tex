...
\begin{table}[H]
\centering
\caption{Fixed constants used in the raw spread prior of \eqref{eq:raw_spread}.}
...
For reading, the vector in \eqref{eq:x79} can be grouped into five blocks:
...
\eqref{eq:ant_bin_v2}: \texttt{low\_ant} for
...
\(t_{41}n_{41}\), which is the last entry of \eqref{eq:x79}, is left

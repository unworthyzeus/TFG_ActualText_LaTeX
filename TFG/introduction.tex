...
for UMa/UMi scenarios. The proposal also fixed a secondary engineering goal,
namely a 10 to 100$\times$ reduction in channel-map generation time compared to
a ray tracer. Chapter~\ref{chap:results} checks this explicitly by comparing
the measured inference time of the final model with the approximate ray-tracing
time needed to create the CKM dataset.

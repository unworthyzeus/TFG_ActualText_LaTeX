...
The LoS branch then adds the fitted ground-reflection interference term,
...
profiles. For this reason the final vector keeps some correlated terms when
they improved validation behavior.

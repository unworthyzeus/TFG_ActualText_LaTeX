...
\begin{equation}
  G(e)=10^{e/10}.
\end{equation}
Thus the final \SI{1.6950}{dB} attenuation RMSE is about \(1.48\times\) in
...
\end{equation}
The final \SI{26.6915}{ns} delay spread RMSE therefore corresponds to
...
RMSE is \(8.4556^\circ\), below both the global \(11.4197^\circ\) value and

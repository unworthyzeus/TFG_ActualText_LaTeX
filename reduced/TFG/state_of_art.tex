...
read the method. Section~\ref{sec:soa_ckm_context} defines the channel
knowledge map (CKM) surrogate setting and the evaluation protocol.
...
Most reviewed angular spread work reports scalar link level angle of arrival or
...
\section{Synthesis: Gap Addressed by This Thesis}

...
The final stage changed the role of deep learning again. The path-loss prior built a strong
interpretable path-loss prior from FSPL, enhanced two-ray LoS propagation, and
calibrated NLoS corrections. The spread-prior module built log-domain ridge-calibrated priors
for delay and angular spread. The final residual GMM-head model then combined these frozen priors with a
shared multi-task residual GMM-head network.

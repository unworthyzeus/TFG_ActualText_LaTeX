...
ground-only metric. PMNet-inspired and U-Net-style backbones improved smooth LoS structure
...
The reproducibility record is public as live source repositories. For archival
submission, these repositories should be pinned to release tags or DOI-backed
snapshots; the citations below identify the current public source locations.
...
This paper reports the final thesis result as a dense UAV CKM surrogate under a

...
against same protocol internal baselines because no external dense CKM
attenuation/DS/AS benchmark was found.
...
frozen prior across train, validation, test, and every morphology/height audit
group, making the gain harder to dismiss as one easy city mix. The modest delay
...
continuous channel attenuation, DS, and AS values; the \SI{0.9298}{dB} final
...
frequency, antenna pattern, and simulator assumptions.
...
Under strict city holdout, the final model reaches \SI{1.6519}{dB},
\SI{26.5570}{ns}, and \(11.3854^\circ\), respectively. Its main contribution is
...
calibration, morphology aware NLoS correction, visibility switching, and log
...
\SI{0.2865}{dB}, \SI{1.5453}{ns}, and \(2.3562^\circ\) RMSE on the held out
test set. Continuous transmitter height is handled through both the priors and
a sinusoidal FiLM path, avoiding per altitude retraining.
...
structure those priors cannot explain.

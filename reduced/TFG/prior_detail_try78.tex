...
\subsection{Hybrid path loss prior assembly}

The calibrated LoS and NLoS branches are assembled into one frozen channel
attenuation prior by switching on the LoS mask. The quantitative audit of this
prior is reported in Chapter~\ref{chap:results}; this subsection only records
the final assembly used as input to \textsc{HARP-Net CKM}.

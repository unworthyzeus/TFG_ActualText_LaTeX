...
(5339 topology-assigned rows). The spread table uses the final 14-city test
...
\midrule
12--50 m & 2.177 & 1.800 & 3.725 & 1294 \\
50--150 m & 1.917 & 1.770 & 3.181 & 2802 \\
150--300 m & 1.671 & 1.657 & 2.227 & 846 \\
300--500 m & 1.576 & 1.568 & 2.229 & 396 \\
\bottomrule
\end{tabular}
\end{table}
...
\SI{1.39}{dB} in open sparse low-rise maps to \SI{2.96}{dB} in dense block
high-rise maps. The NLoS branch is hardest in sparse vertical and dense
high-rise regimes, reaching \SI{3.93}{dB} and \SI{4.10}{dB}; the overall
pixel-weighted prior remains \SI{1.91}{dB}.
...
reached \SI{1.9072}{dB} RMSE on its held-out validation+test split and

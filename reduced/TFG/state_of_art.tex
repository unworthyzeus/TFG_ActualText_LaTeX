...
In practice, the distributions of
...
Multiplying normalised RMSE by~36 gives the following rough dB-scale references:
...
ICASSP~2023 winner PMNet \cite{pmnet_icassp2023,icassp2023challenge} & approx.\ 1.38\,dB & No & Approximate conversion from 0.0383 normalised RMSE using the RadioMap3DSeer 36\,dB image-window convention. \\
...
AIRMap \cite{airmap2025} & path-gain $<4$\,dB vs.\ ray tracing; field calibration reported as median percentage error & Partial & Useful deployment-scale reference, but the reported target is path gain rather than this thesis's calibrated path-loss RMSE. \\

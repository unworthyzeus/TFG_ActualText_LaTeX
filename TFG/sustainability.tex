...
Try~80 generator took \SI{5.61}{s} per sample including geometric LoS/NLoS mask
generation, Try~78/79 prior computation, and PL/DS/AS prediction. Extrapolated
to 16{,}180 samples, this is \SI{448.96}{h} for ray tracing versus
\SI{25.20}{h} for the surrogate. Under the simple same-laptop full-load
assumption of \SI{100}{W}, the energy figures are approximately
\SI{44.9}{kWh} and \SI{2.5}{kWh}, respectively. These figures are not a full
...
\(17.8\times\) faster and, under the same power-envelope assumption, about
\(17.8\times\) more energy efficient.

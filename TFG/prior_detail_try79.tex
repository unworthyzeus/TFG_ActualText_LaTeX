...
\end{tikzpicture}
\caption{Feature grouping used by the calibrated spread prior.
...
\end{tikzpicture}
\caption{Pipeline for the delay and angular spread priors. Both spread modalities share this identical linear architecture, predicting expected spread in the log domain via regime-wise ridge regression over 23 spatial and geometric features.}

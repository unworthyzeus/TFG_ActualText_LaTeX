...
Try~80 generator took \SI{1.22}{s} per sample including geometric LoS/NLoS mask
...
\SI{5.47}{h} for the surrogate. Under the simple same-laptop full-load
assumption of \SI{100}{W}, the energy figures are approximately
\SI{44.9}{kWh} and \SI{0.55}{kWh}, respectively. These figures are not a full
...
\(82.0\times\) faster and, under the same power-envelope assumption, about
\(82.0\times\) more energy efficient.

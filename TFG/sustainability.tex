...
final prior-anchored generator took \SI{0.88}{s} per sample including
geometric LoS/NLoS mask generation, torch computation of the calibrated
path-loss and spread priors, and PL/DS/AS prediction, excluding optional PNG
export. The default numerical \texttt{.npz} archive export is part of the
speed calculation.

...
\subsection{RMSE by Transmitter Height}
...
sign follows the prior error maps. The compact diagnostic appendix keeps the
...
held out test sample in Vancouver. Related compact diagnostics are kept in

...
receiver masking, explicit LoS/NLoS and height reporting, and a bounded
\textsc{HARP-Net CKM} neural correction around frozen priors.
...
\end{tikzpicture}}
\caption{Compact prior anchored pipeline used for \textsc{HARP-Net CKM}.
...
\begin{table}[t]
\centering
\caption{\textsc{HARP-Net CKM} loss schedule. The pre fine tuning residual/GMM stage is part
...
\textsc{HARP-Net CKM} residual corrector.
...
CKM simulation contract, \textsc{HARP-Net CKM} is

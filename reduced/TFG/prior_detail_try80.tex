...
\subsection{\textsc{HARP-Net CKM} Residual Head}
...
\paragraph{Detailed \textsc{HARP-Net CKM} residual head.}
For each task
...
\caption{Detailed \textsc{HARP-Net CKM} residual head used by the final model.}
...
\begin{table}[!htbp]
\centering
\caption{Active loss settings in the \textsc{HARP-Net CKM} stages.}

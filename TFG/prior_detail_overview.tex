This section provides the compact main-text documentation for the
ML-calibrated physical path-loss and spread priors and the final joint
residual GMM-head model architecture. The detailed mathematical derivations and
implementation-level fitting notes are moved to Appendix~\ref{app:formula_details}
so that the methodology chapter explains the design without duplicating the
appendix.
...
detailed equations and fitting procedures are collected in

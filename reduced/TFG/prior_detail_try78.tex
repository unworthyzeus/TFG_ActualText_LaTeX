...
\((h_{\mathrm{tx}}-h_{\mathrm{rx}})^2\) is non-negative,
...
\item $+3$: the COST-231 metropolitan correction constant (dB), corresponding
      ...
      COST-231 deployment recipe; it is one empirical axis later re-fitted by
...
These A2G constants are implementation constants in the Try~78/80 prior code
...
pseudo-inverse solution, not as a requirement that every calibration block be

...
reported in Table~\ref{tab:try78_by_topology}.
...
tables use the same city holdout test contract as Table~\ref{tab:try79_results}
...
\subsection{Final test contract and headline results}

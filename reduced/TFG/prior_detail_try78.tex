...
was very expensive to rerun: the calibration aggregates \(513\times513\) pixels
over roughly \(10\,000\) samples. The linear raw prior, morphology, elevation
and bias terms carry the effect. A later calibration should drop it.

...
geometry-assisted CNN. This thesis tested this channel through
a PMHHNet-style encoder alongside the topology map; the effect on the final pipeline is
...
regulariser. The PMHHNet diagnostic phase in this thesis implemented a lightweight analogue:
...
RadioDiff reports $0.5$ to $2\,\mathrm{dB}$ improvement over deterministic
...
AIRMap \cite{airmap2025} & Partial & No & Yes & Partial \\
...
The $9$ to $10\,\mathrm{dB}$ barrier common to both indoor and outdoor NLoS is not
...
4 & Test-time adaptation on target city & RadioPiT \cite{radiopit2025} & Low to medium \\

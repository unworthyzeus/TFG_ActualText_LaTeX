...
multitask attenuation model. Per pixel dense prediction of delay spread and
angular spread over $513 \times 513$ maps is, to the best of the author's
knowledge, not addressed by the reviewed methods.
...
angle of departure statistics rather than dense CKM maps under city holdout.
Chapter~4 therefore compares angular spread mainly against the frozen prior, the
thesis target, and nearby papers whose tasks are related but not equivalent.
...
the frozen prior, the thesis target, and nearby papers whose tasks are related
but not equivalent.

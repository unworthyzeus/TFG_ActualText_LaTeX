...
leaderboard. Final thesis results are reported only in
...
% Section separator
\section{Channel Attenuation Prediction}
...
the radial rings later exploited by the path loss prior. The numerical gain of
this prior is not reported here because this chapter is background. The fitted
CKM result is evaluated later in Chapter~\ref{chap:results}.

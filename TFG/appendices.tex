...
Main losses & Final fine-tune weights: RMSE 1.0, MAE 0.05, anchor 0.01,
prior-guard 0.02. NLL, KL, moments and outlier terms remain implemented but
...
a \(513\times513\) full-resolution map. The timed Try~80 path starts after the
checkpoint has been loaded once and includes geometric LoS/NLoS mask
generation, frozen Try~78/79 prior computation, and neural prediction of path
loss, delay spread, and angular spread. On the RTX~3050~Ti Laptop GPU, CUDA
...
frozen priors, and \SI{0.54}{s} for the Try~80 neural forward pass. The

...
tables use the same city holdout test contract as Table~\ref{tab:spread_prior_results}
...
prediction claim. The same pixel weighted RMSE contract defined in
Chapter~\ref{chap:methodology} is used for the model and for the frozen priors.

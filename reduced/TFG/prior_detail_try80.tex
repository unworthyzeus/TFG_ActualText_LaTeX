...
The final model introduces a joint multitask residual GMM head architecture that
...
prior anchored GMM assembly rule. After these shared features are computed,

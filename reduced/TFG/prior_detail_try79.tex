...
\(\delta_{15},\delta_{41}\) & Fine/coarse local building density. & Counts nearby reflectors and blockers. \\
...
are not repeated here. The spread prior also uses the six topology labels
defined in \eqref{eq:topology_class_sp_support}; these labels are map level
routing keys for the ridge models, not extra per pixel morphology features.

\subsubsection{Regime wise ridge regression}

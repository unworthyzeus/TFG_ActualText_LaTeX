...
claim is that \textsc{HARP-Net CKM} is a prior anchored residual corrector, and the visible
...
{Final residual GMM head model appendix panels generated from selected validation/test samples with the

...
Transmitter & One centred UAV; \(h_{\mathrm{tx}}\approx\SIrange{12}{478}{m}\) \\
...
\coordinate (filmbusC) at (9.70,-0.18);
\coordinate (filmbusD) at (11.20,-0.18);
\coordinate (filmbusB) at (18.55,-0.18);
\draw[condarr] (hmlp.north) -- (filmbusA) -- (filmbusC);
\draw[condarr] (filmbusD) -- (filmbusB);
...
\draw[condarr] (11.20,-0.18) -- ([xshift=0.30cm]global.north);
...
\draw[skiparr] ([yshift=0.18cm]down1.north) -- ([yshift=0.18cm]up1.north);
\draw[blue!65, thick, dashed] (skip.south) -- ++(0,-0.28);
\end{tikzpicture}}
...
The dashed skip arrow summarizes the four encoder--decoder concatenations used
